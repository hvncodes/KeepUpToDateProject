...
class New_Task_Form_Test(TestCase):
    ...
    def test_TaskForm_is_valid(self):
        form = TaskForm(data={'taskname': "Check up", 'tasktype': "Monthly", 'user': "John", 'taskentrydate': "2019-03-22", 'taskurl': "google.com", 'taskdescription': "words go here"})
        self.assertTrue(form.is_valid())
    # Invalid Form Data
    def test_UserForm_invalid(self):
        form = TaskForm(data={'taskname': "Check up", 'tasktype': "Monthly", 'user': "John", 'taskentrydate': "2018-03-22", 'taskurl': "google.com", 'taskdescription': "task description goes here"})
