...
class New_Task_Form_Test(TestCase):
    ...
    def test_TaskForm_is_valid(self):
        form = TaskForm(data={'taskname': "Check up", 'tasktype': "Monthly", 'user': "John", 'evententrydate': "2019-03-22", 'eventurl': "google.com", 'eventdescription': "words go here"})
        self.assertTrue(form.is_valid())
    # Invalid Form Data
    def test_UserForm_invalid(self):
        form = TaskForm(data={'taskname': "Check up", 'tasktype': "Monthly", 'user': "John", 'evententrydate': "2018-03-22", 'eventurl': "google.com", 'eventdescription': "task description goes here"})
